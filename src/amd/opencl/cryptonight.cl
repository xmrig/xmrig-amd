...
#define VARIANT_XCASH = 16    // Cryptonight (2) variant xcash
#define VARIANT_ZELERIUS = 17 // Cryptonight (2) variant zelerius
...
R"===(
__attribute__((reqd_work_group_size(WORKSIZE, 1, 1)))
__kernel void cn1_xcash(__global uint4 *Scratchpad, __global ulong *states, uint variant, __global ulong *input, uint Threads)
{
#   if (ALGO == CRYPTONIGHT)
    ulong a[2], b[4];
    __local uint AES0[256], AES1[256], AES2[256], AES3[256];
