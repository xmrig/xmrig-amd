...
constexpr const uint32_t CRYPTONIGHT_SWAP_ITER    = 0x20000;
...
template<> inline constexpr uint32_t cn_select_iter<CRYPTONIGHT, VARIANT_SWAP>()       { return CRYPTONIGHT_SWAP_ITER; }
...
template<> inline constexpr Variant cn_base_variant<VARIANT_SWAP>()   { return VARIANT_0; }
