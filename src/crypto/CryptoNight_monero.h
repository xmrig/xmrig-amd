...
#ifdef _MSC_VER
#   define VARIANT2_SET_ROUNDING_MODE() if (VARIANT == xmrig::VARIANT_2 || VARIANT == xmrig::VARIANT_XTL_V9) { _control87(RC_DOWN, MCW_RC); }
#else
#   define VARIANT2_SET_ROUNDING_MODE() if (VARIANT == xmrig::VARIANT_2 || VARIANT == xmrig::VARIANT_XTL_V9) { fesetround(FE_DOWNWARD); }
#endif
